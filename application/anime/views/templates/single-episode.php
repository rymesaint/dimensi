	...
	<section class="content col-lg-8 col-md-8">
		<nav>
			<ol class="breadcrumb" itemscope itemtype="http://schema.org/BreadcrumbList">
				...
				<li class="current" itemprop="itemListElement" itemscope itemtype="http://schema.org/ListItem">
					<a itemprop="item" href="<?php echo site_url('anime/'.$anime->permalink.'/'.$sAnime->episode.'/') ?>">
						<span itemprop="name">Episode <?php echo $sAnime->episode ?></span>
						<meta itemprop="position" content="3"/>	
					</a>
				</li>
			</ol>
		...
		<header>
			<div class="single-bullet-title">
				...
				<?php echo $anime->title_anime ?> Episode <?php echo $sAnime->episode ?>
			</div>
		</header>
		...
		<div class="wrapper-comments">
			...
			<script type="text/javascript">
			    ...
			    var disqus_title = 'Streaming <?php echo $anime->title_anime; ?> Episode <?php echo $sAnime->episode; ?>';
			    var disqus_url = '<?php echo base_url()."anime/".$anime->permalink."/".$sAnime->episode."/"; ?>';
		...
		<div class="wrapper_sidebar">
			...
			<div class="sidebar_content">
				...
				<div class="form-group">
				  ...
				  <div class="col-md-8">
				  <input id="episodeNum" name="episodeNum" type="text" placeholder="Masukan No Episode" value="<?php echo set_value('episodeNum', $sAnime->episode) ?>" class="form-control input-md" required="">
