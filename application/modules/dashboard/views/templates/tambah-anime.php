...
<div class="row">
  <form class="col s12" action="<?php echo site_url('dashboard/animes/proses/tambah') ?>" method="POST" enctype="multipart/form-data">
    <div class="row">
      <div class="input-field col s12">
        <select id="series" name="series" required>
          <option value="" disabled selected>Pilih Series Anime</option>
          <option value="tv">TV</option>
          <option value="ova">OAV/OVA</option>
    ...
    <div class="row">
      <div class="input-field col s12">
        <input placeholder="Judul Anime" id="judul-anime" name="judul-anime" type="text" class="validate">
        <label for="judul-anime">Judul Anime</label>
      </div>
    </div>
    <div class="row">
      <div class="input-field col s12">
        <textarea id="synopsis" class="materialize-textarea" name="synopsis" placeholder="Sinopsis Anime"></textarea>
      ...
      <div class="input-field col s12">
        <select id="genre" class="genre form-control" multiple="multiple" name="genre[]">
          <?php foreach($genres as $genre): ?>
            <option value="<?php echo $genre->namegenre ?>"><?php echo $genre->namegenre ?></option>
          <?php endforeach; ?>
        </select>
    ...
    <div class="row">
      <div class="input-field col s12">
        <input placeholder="Max. Episode" id="episodes" name="episodes" type="number" class="validate" required>
    ...
    <div class="row">
      <div class="input-field col s12">
        <input placeholder="Nama Studio Produksi" id="studio" name="studio" type="text" class="validate">
      ...
      <div class="input-field col s12">
        <select id="season" class="season form-control" name="season" required>
          ...
          <?php foreach($seasons as $season): ?>
            <option value="<?php echo $season->idseason ?>"><?php echo $season->nama_season ?></option>
          <?php endforeach; ?>
        </select>
